...
var app = (function () {
    ...
    /* src/Tailwind.svelte generated by Svelte v3.22.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "");
    			add_location(h1, file, 14, 2, 319);
    			add_location(h2, file, 15, 2, 354);
    			add_location(h3, file, 16, 2, 375);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 19, 4, 421);
    			add_location(p, file, 17, 2, 399);
    			attr_dev(main, "class", "bg-green-500");
    			add_location(main, file, 13, 0, 289);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwindcss: Tailwind, onMount, name, message });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 1, message: 0 });
